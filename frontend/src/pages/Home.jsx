    ...
    <div>
      ...
      <section className="py-16 px-4 bg-sage-50">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="font-display text-2xl font-semibold text-sage-900 mb-6">
            Shop by Category
          </h2>

          {loading ? (
            <p className="text-sage-600">Loading categories...</p>
          ) : categories.length === 0 ? (
            <p className="text-sage-600">No categories found.</p>
          ) : (
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {categories.map((c) => (
                <Link
                  ...
                  className="block bg-white border border-floral-200 rounded-xl p-6 hover:shadow-md transition"
                >
